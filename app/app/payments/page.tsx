    ...
    return (
      <Container variant="wide" className="space-dashboard">
        <div className="space-element">
          <Heading level={1} className="space-tight">Credits</Heading>
          <Text variant="base" muted>Manage your Aqua credits and usage</Text>
        </div>
    ...
    <Container variant="wide" className="space-dashboard">
      ...
      <div className="space-element">
        ...
        <Text variant="base" muted className="max-w-3xl">
          Manage your Aqua credits, monitor usage, and purchase additional credits for your deployments.
        </Text>
      </div>
      ...
      <Grid variant="responsive-4" className="space-component">
        ...
        <StatsCard
          ...
          value={creditDetails.usageStatistics.estimatedDaysRemaining?.toString() || "∞"}
          ...
          <Card variant="primary">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Text variant="caption" className="mt-1">1 USD = 100 Credits</Text>
              </div>
            ...
            <div className="space-y-3">
              {displayedTransactions.map((transaction) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <Text variant="small" className="font-medium space-tight">
                        {transaction.type === 'CREDIT' ? 'Credit Purchase' : 'Deployment Usage'}
                      </Text>
                      <Text variant="caption" muted>
                  ...
                  <div className="text-right">
                    <Text variant="small" className={`font-medium ${
                      transaction.type === 'CREDIT' ? 'text-green-400' : 'text-orange-400'
                    }`}>
